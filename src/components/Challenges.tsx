...
const Challenges = () => {
  return (
    <section id="why-reamstack" className="py-20 relative bg-[#020617] overflow-hidden">
            ...
            <HoverCard key={index} openDelay={0} closeDelay={0}>
              <HoverCardTrigger asChild>
                <div className="group h-full">
                  <div className="relative h-full rounded-lg p-[1px] bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 hover:shadow-[0_0_2rem_-0.5rem_#fff8] transition duration-300">
                    <div className="relative h-full p-4 rounded-lg bg-[#020617] backdrop-blur-3xl">
              ...
              <HoverCardContent className="w-80 bg-[#020617] text-white border-gray-700">
