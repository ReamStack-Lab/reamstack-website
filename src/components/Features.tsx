...
const Features = () => {
  return (
    <section id="features" className="py-20 relative bg-[#020617] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="group h-full">
              <div className="h-full p-6 rounded-lg bg-[#020617]/80 backdrop-blur-3xl border border-gray-800 hover:border-gray-700 transition-all duration-300">
